...
present_value = calculate_present_value(new_loan['future_value'], new_loan['remaining_months'])
print(f"The present value of the new_loan is: {present_value}")
...
for loan in loans:
    ...
    present_value = calculate_present_value(loan['future_value'], loan['remaining_months'])
